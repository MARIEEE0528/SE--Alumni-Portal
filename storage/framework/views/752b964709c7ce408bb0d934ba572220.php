...
<body>
    ...
    <body class="bg-white-10 flex flex-col flex-nowrap">
        ...
        <!--Overlay/Event-->
          ...
          <img class="w-[400px] h-[450px] top-[270px] left-[730px] absolute" src="/images/Rectangle 4355.png"/>
          <button class= "" onclick="window.location.href='<?php echo e(url('event1')); ?>'">
           <img class="w-[33px] h-[33px] absolute top-[285px] left-[780px]" src="/images/Close_square.png"/>
          </button>
          ...
          <span class="text-blue-hover w-[370px] text-[10px]  font-['Inter'] absolute top-[560px] left-[750px] ">
           ...
           <span class="text-blue-hover w-[370px] text-[10px] font-bold font-['Inter'] absolute top-[640px] left-[750px] whitespace-pre-line ">
            Location:
            Date and Time:
            Register:
          </span>
...
<?php /**PATH C:\Users\Marie\laravel_SE\resources\views/Upcoming Event2.blade.php ENDPATH**/ ?>