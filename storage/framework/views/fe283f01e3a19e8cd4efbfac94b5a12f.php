        ...
        <div class="h-screen w-screen flex flex-col">
            ...
            <div class="flex flex-row">
                ...
                <div class="pt-7 w-screen text-center flex flex-col">
                    ...
                    <span class="text-[17px] w-[700px] h-[63px] ml-[10rem] mt-1 font-inter font-light opacity-60 text-blue-hover whitespace-pre-line ">
                    ...
                    <!--FORMS HERE-->
                        <!--TITLE OF EVENT-->
                      <div class="mx-[8.2rem] mt-[2rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue" x-data="{name: '' }">
                        <input class="font-inter text-center px-[2rem] focus:outline-none" type="text" x-model="name" placeholder="Company Name *">
                      </div>

                          <!--Email Address-->
                      <div class="mx-[8.2rem] mt-[1.5rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue" x-data="{name: '' }">
                        <input class="font-inter text-center px-[2rem] focus:outline-none" type="text" x-model="name" placeholder="Company Email Address *">
                      </div>

                          <!--Company Address-->
                      <div class="mx-[8.2rem] mt-[1.5rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue" x-data="{name: '' }">
                            <input class="font-inter text-center px-[2rem] focus:outline-none" type="text" x-model="name" placeholder="Company Address *">

                      </div>

                          <!--Primary Contact Person-->
                      <div class="mx-[8.2rem] mt-[1.5rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue" x-data="{name: '' }">
                        <input class="font-inter text-center px-[2rem] focus:outline-none" type="text" x-model="name" placeholder="Primary Contact Person *">
                      </div>
                      ...
                      <div class="mx-[8.2rem] mt-[1.5rem] flex flex-row justify-self-center">
                        <div class="mr-[2rem] h-[3rem] bg-white rounded-[14px] py-2 border border-blue" x-data="{name: '' }">
                            <input class="font-inter text-center px-[4rem] focus:outline-none" type="text" x-model="name" placeholder="Start Date *">

                          </div>
                          <div class="h-[3rem] bg-white rounded-[14px] py-2 border border-blue" x-data="{name: '' }">
                            <input class="font-inter text-center px-[4rem] focus:outline-none" type="text" x-model="name" placeholder="End Date *">
            ...
            <div class="absolute justify-center flex flex-col items-center inline-flex">
                ...
                <div class="mt-[1rem] ml-[35rem] flex flex-row justify-center ">
                    <button
                        ...
                        <a href="#" href="#" onclick="window.location.href='<?php echo e(url('news2')); ?>'"
...
</html><?php /**PATH C:\Users\Marie\laravel_SE\resources\views/Apply Partnership.blade.php ENDPATH**/ ?>