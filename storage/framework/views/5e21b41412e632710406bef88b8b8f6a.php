                        ...
                        <div class="ml-6 font-inter font-light text-[20px]">
                            ...
                            <div class="font-inter text-black flex flex-row pb-8">
                                ...
                                <span
                                    ...
                                    <a href="#" href="#"
                                        onclick="window.location.href='<?php echo e(url('event2')); ?>'" class ="hover:text-gold">
                                        View More
                                    </a>
                                </span>
                            </div>
                        ...
                        <div class="absolute justify-center flex flex-col items-center inline-flex">
                            ...
                            <div class="mt-[1rem] ml-[35rem] flex flex-row justify-center ">
                                <button
                                    ...
                                    <a href="#" href="#"
                                        onclick="window.location.href='<?php echo e(url('news2')); ?>'"
...
<?php /**PATH C:\Users\Marie\.vscode\laravel_SE\resources\views/Upcoming Event.blade.php ENDPATH**/ ?>