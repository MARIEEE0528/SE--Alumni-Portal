...
<body>
    ...
    <body class="bg-white-10 flex flex-col flex-nowrap">
        ...
        <div class="h-screen w-screen flex flex-col">
            ...
            <span class="absolute pt-25 pl-[32rem] text-center font-inter font-medium text-[30px] text-white-20 whitespace-pre-line mt-1">
            25 December 2023
            Location
            </span>
<?php /**PATH C:\Users\Marie\laravel_SE\resources\views/Alumni Gallery (2).blade.php ENDPATH**/ ?>