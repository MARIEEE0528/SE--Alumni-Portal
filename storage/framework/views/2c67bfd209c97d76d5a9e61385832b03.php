        ...
        <div class="h-screen w-screen flex flex-col font-inter">
                ...
                <div class="border border-blue rounded-[1.75rem]">
                    <div class="flex flex-row">
                        ...
                        <span class=" mx-[3rem] pr-[3rem] mt-[5rem] whitespace-pre-line text-[24px] font-inter font-bold text-blue-pressed ">
                            LOREM IPSUM DOLOR SIT AMET, 
                        ...
                        <span class="mx-[3rem] pr-[3rem] whitespace-pre-line text-[18px] text-left font-medium font-inter text-black-200">
                            ...
                            <a href="#" href="#" onclick="window.location.href='/resources/views/News2.html'" class="font-bold font-inter dark:text-blue hover:underline hover:text-gold ">
                                View More
                            </a> 
                        </span> 
                    </div>     
                ...
                <div class=" flex flex-col bg-white-10 border-r-2 border-black">
                    ...
                    <div class="ml-[1.5rem] font-inter font-light text-[1.2rem]">
                        ...
                        <div class="font-inter text-black flex flex-row pb-8">
                            ...
                            <a href="#" href="#" onclick="window.location.href='/resources/views/mainpage.html'" class="text-blue-hover pl-28 font-inter dark:text-blue hover:underline text-[18px] hover:text-gold">
                                View More
                            </a>
                        </div>
                    </div>  
...
<?php /**PATH C:\Users\Marie\laravel_SE\resources\views/News3.blade.php ENDPATH**/ ?>